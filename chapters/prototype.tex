...
The \enquote{Happy to Interact} availability status was included to bring back the lack of serendipity in remote work. When selected by at least two members of a team, an automatic match-maker runs every minute and randomly pairs two people, which are then forwarded into a video call.
